...
public class VipStoryController {
    ...
    @Value("${hthang.truyenmvc.title.vip.story}")
    ...
    @Autowired
    public VipStoryController(InformationService informationService,
    ...
    private void loadData(int pagenumber,
                          Model model) {
        Page<NewStory> page = storyService.getVipStoryNew(pagenumber, ConstantsUtils.PAGE_SIZE_DEFAULT);
    ...
    private void loadTopView(Model model) {
        ...
        List<TopStory> listtop = storyService.getTopStoryVip(firstDayOfMonth, lastDayOfMonth,
